...
const I18N = {
  az: {
    ...
    aiGreeting: "Salam! UNEC materialları haqqında sualını ver — cavablayayım.",
    aiServerError: "Server xəta verdi",
    aiNoReply: "Cavab alınmadı.",
    aiConnError: "Bağlantı xətası.",
    aiLimitReached: "Günlük sorğu limitin bitdi ({n}/{n}). Sabah yenidən cəhd et, ya da Premium-a yüksəl.",
  ...
  en: {
    ...
    aiGreeting: "Hi! Ask me anything about UNEC materials — I'll answer.",
    aiServerError: "Server error",
    aiNoReply: "No reply received.",
    aiConnError: "Connection error.",
    aiLimitReached: "Your daily question limit is reached ({n}/{n}). Try again tomorrow, or upgrade to Premium.",
