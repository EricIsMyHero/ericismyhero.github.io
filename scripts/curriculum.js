...
const CURRICULUM_DATA = {
  ...
  economics: {
    ...
    semester5: [
      { name: 'Beynəlxalq iqtisadi münasibətlər',                       credit: 6, hours: 60, absenceLimit: 7, weekly: 4 },
      { name: 'Dövlət maliyyəsi',                                       credit: 6, hours: 60, absenceLimit: 7, weekly: 4 },
      { name: 'Rəqəmsal iqtisadiyyat',                                  credit: 6, hours: 60, absenceLimit: 7, weekly: 4 },
      { name: 'İqtisadi təhlil',                                        credit: 8, hours: 60, absenceLimit: 7, weekly: 4 },
      { name: 'Elmi tədqiqat metodologiyası',                           credit: 4, hours: 45, absenceLimit: 5, weekly: 3 },
    ],
    semester6: [
      { name: 'İqtisadi proqnozlaşdırma',                               credit: 6, hours: 60, absenceLimit: 7, weekly: 4 },
      { name: 'Regional iqtisadiyyat',                                  credit: 5, hours: 60, absenceLimit: 7, weekly: 4 },
      { name: 'Sahibkarlıq iqtisadiyyatı',                              credit: 6, hours: 60, absenceLimit: 7, weekly: 4 },
      { name: 'Statistik məlumatların emalı',                           credit: 5, hours: 60, absenceLimit: 7, weekly: 4 },
      { name: 'Seçmə fənn - 1',                                         credit: 6, hours: 60, absenceLimit: 7, weekly: 4 },
    ],
    semester7: [
      { name: 'İqtisadi siyasət',                                       credit: 6, hours: 60, absenceLimit: 7, weekly: 4 },
      { name: 'İstehsal iqtisadiyyatı',                                 credit: 5, hours: 60, absenceLimit: 7, weekly: 4 },
    ...
    semester8: [
      { name: 'Qloballaşma və iqtisadiyyat',                            credit: 5, hours: 60, absenceLimit: 7, weekly: 4 },
      { name: 'İqtisadi inteqrasiya',                                   credit: 5, hours: 60, absenceLimit: 7, weekly: 4 },
