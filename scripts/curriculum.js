...
const CURRICULUM_DATA = {
  economics: {
    ...
    icon: '📈',
    semester1: [
      { name: 'Mikroiqtisadiyyat', credit: 6, hours: 60, absenceLimit: 15, weekly: 4 },
      ...
      { name: 'Tarix',             credit: 3, hours: 30, absenceLimit: 9,  weekly: 2 },
    ],
    semester2: [
      { name: 'Makroiqtisadiyyat', credit: 6, hours: 60, absenceLimit: 15, weekly: 4 },
      { name: 'Riyaziyyat II',     credit: 5, hours: 45, absenceLimit: 13, weekly: 3 },
      { name: 'Statistika',        credit: 4, hours: 45, absenceLimit: 13, weekly: 3 },
      { name: 'İqtisadi nəzəriyyə', credit: 4, hours: 45, absenceLimit: 13, weekly: 3 },
