...
const themes = {
  ...
  emerald:  { '--bg':'#001209','--surface':'#001e10','--surface2':'#002d18','--accent':'#059669','--accent2':'#10b981','--accent3':'#34d399','--text':'#d1fae5','--muted':'#4a7a62','--border':'rgba(5,150,105,0.18)','--glow':'rgba(5,150,105,0.09)' },
